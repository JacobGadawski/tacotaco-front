<template>
    <div>
        <Table :title="'Best performing students'" :items="students" :keys="[ 'name', 'performance' ]" :unit="'%'" />
        <Table :title="'Students Leadersboard'" :items="students" :keys="[ 'name', 'points' ]" :unit="'pkt'" />
